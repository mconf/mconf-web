    atom_entry(@attachment, {'xmlns:gd' => 'http://schemas.google.com/g/2005', 
    'xmlns:sir' => 'http://sir.dit.upm.es/schema', 'xmlns:thr' => 'http://purl.org/syndication/thread/1.0', 
    :url => formatted_space_attachment_path(@space, @attachment, :atom), 
    :root_url => space_attachment_path(@space, @attachment)}) do |entry|

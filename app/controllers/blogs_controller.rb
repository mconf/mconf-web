class BlogsController < ApplicationController
  ...
  # Blogs list may belong to a container
  # /blogs
  # /:container_type/:container_id/blogs
  
 before_filter :get_space
  # Needs a Container when posting a new Blog
        ...
        respond_to do |format| 
          format.html {
            if !@content.new_record? && @post.save
              ...
              if @post.container_type == 'Space'
                
                redirect_to space_url(@container)

...
class SitesController < ApplicationController
  ...
  def allowed_params
    [
     ...
     :registration_enabled, :require_registration_approval, :captcha_enabled, :recaptcha_public_key, :recaptcha_private_key,
     :local_auth_enabled, :events_enabled, visible_locales: []
    ]
  end
end

module AgendaEntriesHelper
  ...
  def shared_embed(entry)
    ...
    result += '<div style="padding:0 6px 6px 6px;text-align:right;"><a style="text-decoration:none;outline:none;font-weight:bold;color:#fff" href="http://www.globalplaza.org"><img src="/images/bola_global_peque.png" style="margin-bottom:-3px"/> Global Plaza</a></div>'
    result += '</div></div>'

...
describe CustomBigbluebuttonPlaybackTypesHelper do
  ...
  describe "#link_to_playback" do
    ...
    context "when the identifier was presentation_export" do
      ...
      let!(:link) {
        link_to icon_archive, play_bigbluebutton_recording_path(recording, type: presentation_export.identifier), options_for_tooltip(t("bigbluebutton_rails.playback_types.presentation_export.tip"))
      }

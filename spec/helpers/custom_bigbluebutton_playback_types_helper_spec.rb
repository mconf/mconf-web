...
describe CustomBigbluebuttonPlaybackTypesHelper do
  ...
  describe "#link_to_playback" do
    ...
    context "when the identifier is presentation_export" do
      ...
      let(:link) {
        link_to icon_archive, play_bigbluebutton_recording_path(recording, { type: presentation_export.identifier, name: name }), options_for_tooltip(t("bigbluebutton_rails.playback_types.presentation_export.tip"), { download: name })
      }
      before {
    ...
    context "when the identifier is presentation_video" do
      ...
      context 'and the description is set' do
        ...
        let(:link) {
          link_to icon_file_download, play_bigbluebutton_recording_path(recording, { type: presentation_video.identifier, name: name }), options_for_tooltip(t("bigbluebutton_rails.playback_types.presentation_video.tip"), { download: name })
        }

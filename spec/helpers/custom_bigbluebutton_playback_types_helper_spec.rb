  ...
  describe "#link_to_playback" do
    ...
    context "when the identifier is presentation_video" do
      ...
      context 'and the description is set' do
        ...
        let(:link) {
          link_to icon_rec_download, play_bigbluebutton_recording_path(recording, { type: presentation_video.identifier, name: name }), options_for_tooltip(t("bigbluebutton_rails.playback_types.presentation_video.tip"), { download: name })
        }

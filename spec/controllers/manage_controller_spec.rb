      ...
      describe "check_statistics_params" do
        ...
        context "with params" do
          context "date today: result approved_user, admin and superuser" do
            ...
            let(:data) { {:users=>{:count=>4, :approved=>4, :not_approved=>0, :disabled=>0}, :spaces=>{:count=>1, :private=>1, :public=>0, :disabled=>0}, :meetings=>{:count=>1, :total_duration=>0, :average_duration=>0}, :recordings=>{:count=>1, :size=>0, :total_duration=>5, :average_duration=>5}} }
          ...
          context "date 5 months ago until today: result approved_user, not_approved_user, admin and superuser" do
            ...
            let(:end_date) { (Time.now.utc).strftime("%m/%d/%Y").to_s }
            let(:params) { { statistics: { starts_on_time: start_date, ends_on_time: end_date } } }
            let(:data) { {:users=>{:count=>5, :approved=>4, :not_approved=>1, :disabled=>0}, :spaces=>{:count=>1, :private=>1, :public=>0, :disabled=>0}, :meetings=>{:count=>1, :total_duration=>0, :average_duration=>0}, :recordings=>{:count=>1, :size=>0, :total_duration=>5, :average_duration=>5}} }
          ...
          context "date 6 years ago until today: result approved_user, not_approved_user, disabled_user, admin and superuser" do
            ...
            let(:end_date) { (Time.now.utc).strftime("%m/%d/%Y").to_s }
            let(:params) { { statistics: { starts_on_time: start_date, ends_on_time: end_date } } }
            let(:data) { {:users=>{:count=>6, :approved=>5, :not_approved=>1, :disabled=>1}, :spaces=>{:count=>1, :private=>1, :public=>0, :disabled=>0}, :meetings=>{:count=>1, :total_duration=>0, :average_duration=>0}, :recordings=>{:count=>1, :size=>0, :total_duration=>5, :average_duration=>5}} }

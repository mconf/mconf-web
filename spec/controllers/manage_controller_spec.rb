...
describe ManageController do
  # TODO maybe what I added is redundant with the last tests.
  describe "#users" do
    before { User.destroy_all } # exclude seeded user(s)
    context "as a logged in superuser" do
    ...
    context "as a logged in normal user" do
      ...
      before { sign_in(user) }
      it {
        expect { get :users }.to raise_error(CanCan::AccessDenied)
      }
    end
  ...
  describe "#spaces" do
    ...
    context "as a logged in normal user" do
      ...
      before { sign_in(user) }
      it {
        expect { get :spaces }.to raise_error(CanCan::AccessDenied)
      }
    end

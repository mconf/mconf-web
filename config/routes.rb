ActionController::Routing::Routes.draw do |map|
  ...
  map.search '/spaces/:space_id/search', :controller => 'events', :action => 'search' #=> /search/events, SearchController
  ...
  map.search_by_title '/spaces/:space_id/search_by_title', :controller => 'events', :action => 'search_by_title' #=> /search/title/events, SearchController
  map.search_in_description '/spaces/:space_id/search_description', :controller => 'events', :action => 'search_in_description' #=> /search/description/events, SearchController
  map.search_by_date '/spaces/:space_id/search_by_date', :controller => 'events', :action => 'search_by_date' #=> /search/date/events, SearchController
  map.search_articles '/spaces/:space_id/search_articles', :controller => 'articles', :action=> 'search_articles' #=> /search/articles, SearchController
  map.search_all '/spaces/:space_id/search_all', :controller => 'home', :action=> 'search' #=> /search, SearchController
  map.search_by_tag '/spaces/:space_id/tags/:tag', :controller => 'events', :action => 'search_by_tag' #=> /tags/:id/events, TagsController
  ###########################################
  # RUTAS A LIMPIAR
  # #########################################
  #
  ...
  #
  #map.show_ajax '/spaces/:space_id/events/show_ajax/:id', :controller => 'events', :action => 'show_ajax' #=> /spaces/:space_id/events/:id.rjs, EventsController#show.rjs
  ...
  #map.show_summary '/spaces/:space_id/show_summary/:id' , :controller => "events", :action => "show_summary" #=> /events/:id.rjs, EventsController#show.rjs
  
  
 
 map.title '/spaces/:space_id/title_search', :controller => 'events', :action => 'title' #=> /search/title, SearchController
 map.description '/spaces/:space_id/description_search', :controller => 'events', :action => 'description' #=> /search/description, SearchController
 map.clean '/spaces/:space_id/clean', :controller => 'events', :action => 'clean' #=> SearchController ??
  map.dates '/spaces/:space_id/search_by_dates', :controller => 'events', :action => 'dates'

   #PROFILES CONTROLLER

  map.profile '/spaces/:space_id/users/:user_id/profile', :controller => 'profiles' , :action => 'show' #=> /users/:user_id/profile, ProfileController#show, se llama con: user_profile_path(@user) 
  map.new_profile '/spaces/:space_id/users/:user_id/profile/new', :controller => 'profiles' , :action => 'new'    #=> /users/:user_id/profile/new, ProfileController#new, se llama con: new_user_profile_path(@user) 
  ...
  map.show_space_users '/spaces/:space_id/space_users', :controller => 'users' , :action => 'show_space_users'  #=> /spaces/:space_id/users, UsersController#index 
 ...
 map.search_by_tag '/search_tag', :controller => 'users', :action=> 'search_by_tag' #=> /tags/:id/users, TagsController o UsersController ?
  map.search_users '/spaces/:space_id/search_users', :controller => 'users', :action=> 'search_users' #=> /search/users, SearchController
  map.manage_users '/spaces/:space_id/manage_users', :controller => 'users', :action => 'manage_users' #=> /spaces/:space_id/users, UserController#index
  map.search_users2 '/spaces/:space_id/search_all_users', :controller => 'users', :action => 'search_users2' #=> /search/users ???
